const WatchMovie = () =>{
    return(
        <div className="py-16 px-1.5 sm:px-28 md:flex ">
            ...
            <div>
                <p className="text-gray-200 leading-6 font-iran-sans text-[.8rem] xl:text-xs lg:text-[.8rem] ">
            ...
            <div className="flex mb-8 md:mt-6">
                ...
                <div className="mr-4 leading-3">
                    <div>
                        <p className="text-gray-200 font-iran-sans text-sm xl:font-iran-sans-medium">کامپیوتر و لب تاپ </p>
                    </div>
                    <div>
            ...
            <div className="flex mb-8 ">
                ...
                <div className="mr-3 ">
                    <div>
                        <p className="text-gray-200 font-iran-sans text-sm xl:font-iran-sans-medium">موبایل و تبلت </p>
                    </div>
                    <div>
            ...
            <div className="flex mb-8">
                ...
                <div className="mr-4 leading-3">
                    <div>
                        <p className="text-gray-200 font-iran-sans text-sm xl:font-iran-sans-medium ">کنسول های بازی (Browser)</p>
                    </div>
                    <div>
